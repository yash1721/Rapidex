        ...
        <View style={{ flex: 1, padding: 20, backgroundColor: '#e1e4ee', alignItems: 'center' }}>
            ...
            <FadeIn delay={500}>
                <View style={{ width: 350, marginTop: 50 }}>
                    ...
                    <View>
                    <TextInput placeholder='Enter Email' placeholderTextColor={'#bdb8c0'} fontSize={16} style={{ fontFamily: 'Poppins-Regular', paddingHorizontal: 20, paddingVertical: 15, backgroundColor: '#f8f6f9', borderRadius: 10, marginTop: 10}} />
                    </View>
                    <View>
